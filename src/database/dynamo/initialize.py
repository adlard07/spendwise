...
class DynamoClient:
    ...
    def put_item(self, table_name: str, item: dict, condition: str = None) -> dict:
    ...
    def delete_one(self, table_name: str, key: dict, condition: str = None) -> dict:
        table = self._get_table(table_name)
        params = {
            "Key": key,
...
if __name__ == "__main__":
    client = DynamoClient()
    tables = list(client.dynamodb.tables.all())
    print("Tables:", tables)
